...
BUILDFILE = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/buildtvban/builds.txt-'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/buildtvban/apks.txt'
# Text File with Youtube Videos urls.  Leave as 'http://' to ignore
YOUTUBETITLE = '[B][COLOR red]Conciertos[/COLOR] TVBAN [/B]'
YOUTUBEFILE = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/buildtvban/youtube.txt'
# Text File for addon installer.  Leave as 'http://' to ignore
ADDONFILE = 'http://'
# Text File for advanced settings.  Leave as 'http://' to ignore
ADVANCEDFILE = 'https://raw.githubusercontent.com/andtvban/andtvban.github.io/master/bankod/wizard/json/advanced.json'
#########################################################
...
REPOADDONXML = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/bankod/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/bankod/zips/repository.andTVban/'
#########################################################
...
NOTIFICATION = 'https://raw.githubusercontent.com/andtvban/repositorio.tvbankod/master/buildtvban/andtv/Notify.txt'
